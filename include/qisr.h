 ...
 * @see		
 */
const char* ISRAPI QISRUploadData(const char* sessionID, const char* dataName, void* data, unsigned int dataLen, const char* params, int* errorCode);
typedef const char* (ISRAPI* Proc_QISRUploadData)(const char* sessionID, const char* dataName, void* data, unsigned int dataLen, const char* params, int* errorCode);
#ifdef MSP_WCHAR_SUPPORT
const wchar_t* ISRAPI QISRUploadDataW(const wchar_t* sessionID, const wchar_t* dataName, void* data, unsigned int dataLen, const wchar_t* params, int* errorCode);
typedef const wchar_t* (ISRAPI* Proc_QISRUploadDataW)(const wchar_t* sessionID, const wchar_t* dataName, void* data, unsigned int dataLen, const wchar_t* params, int* errorCode);
#endif
